...
public class Person : MonoBehaviour
{
    ...
    public void Walk(int speed, string direction = "前方", string sound = "咖咖咖", string shoes = "皮鞋")
    {
    ...
    public void Attack()
    {
        print(gameObject.name + "的徒手攻擊！");
    }

    /// <summary>
    /// 使用武器攻擊
    /// </summary>
    /// <param name="weapon">想要使用的武器名稱</param>
